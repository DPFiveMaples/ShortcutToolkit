...
IniRead,AccessToken,\\Watson\Production\X\DP Use\Shared AHKs\Toolkit.ini, AccessTokens, ShortCutAccessToken, "ERROR - NO KEY FOUND!"
...
;==  Update Module
;===========================================================
; Files if hosted on Github    : See AccessToken in X:\DP Use\Shared AHKs\Toolkit.ini
...
::Jam::Carol Martin`t8023875157`t110 ;c 🌟 Populate Warehouse Name & Number ⌨️ Type "jam" & Hit Tab OR just press the Warehouse NDC SCF Info button | This will auto-populate the warehouse info on the NDC/SCF 8125 screen
; :*:jam`t::Carol Martin`t8023875157`t110 ; Old - replaced by above
