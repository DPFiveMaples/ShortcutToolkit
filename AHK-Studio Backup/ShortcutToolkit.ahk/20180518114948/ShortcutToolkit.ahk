...
#+^m:: ;c Ctrl+Shift+Win+m will trigger the Warehouse Macro - this will launch the Google Sheet and (after a couple of clicks) send an email to Heather.
{
	...
	m.Subject := "Thank you!"
	m.To := hmetzger@bib-arch.org ;This will provide a variable option, but will have to be redone: ClientEmail ; This should be changed in the future to be the variable "ClientEmail"
