...
#+^m:: ; Ctrl+Win+Shift+m
{
	...
	Else If clipboard = %A_MM%/%A_DD%/%A_YYYY% ; If they are the same...
	{
		...
		m.Subject := "Hi There"
		m.To := "abc@123.com" ; This should be changed in the future to be the variable "ClientEmail"
		...
		m.Body :="Dear %Salutation%, `n`n Good news: your thank you letter file has been mailed. `n`n File Name: %FileName% `n`n not worry about how long it is...or worry about the non-formatting issues that come from the mailto: command`n`n`n`n ...yes, that is a whole bunch of "new Lines" to show you how you can format this however you want...`n`n`n`n`n`n`n`n AND IT WORKS
