...
#+^m:: ;c Ctrl+Shift+Win+m will trigger the Warehouse Macro - this will launch the Google Sheet and (after a couple of clicks) send an email to Heather.
{
	...
	Sleep,  50
	Progress, zh0 fs18, Please click the cell containing the Enter Date of the row `n that you wish to email about,  and then press Scroll Lock to proceed. `n This notice will remain until you do. :D 
	KeyWait, CtrlBreak, D
	Progress, Off
	Sleep, 50
	Send, ^c
	...
	m.Subject := "Thank you!"
	m.To := %ClientEmail% ; This should be changed in the future to be the variable "ClientEmail"
