...
#+^m:: ;c Ctrl+Shift+Win+m will trigger the Warehouse Macro - this will launch the Google Sheet and (after a couple of clicks) send an email to Heather.
{
	...
	Sleep,  50
	Progress, zh0 fs18, Please click the cell containing the Enter Date of the row that you wish to email about,  and then press 'Pause' to proceed. This notice will remain until you do. :D 
	KeyWait, PAUSE, D
	Progress, Off
	settitlematchmode 2
